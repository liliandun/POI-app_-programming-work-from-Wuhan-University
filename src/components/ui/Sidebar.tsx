    ...
    <>
      ...
      <aside
        className={`
          ...
          border-r border-white/[0.06] bg-[#0c0700]/95 backdrop-blur-2xl
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-6 border-b border-white/[0.06]">
          ...
          <button
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center rounded-lg text-white/40 hover:bg-white/10 hover:text-white lg:hidden"
          >
